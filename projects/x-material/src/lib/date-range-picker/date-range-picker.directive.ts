...
@Directive({
  selector: 'input[xMatDateRangePicker]',
  host: {
    '(keyup.esc)': 'hide()',
    '(blur)': 'onBlur()',
    '(click)': 'open()',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => XMatDateRangePickerDirective),
      multi: true,
    },
  ],
})
export class XMatDateRangePickerDirective implements OnInit, OnChanges, DoCheck {
  ...
  constructor(
    ...
    this.drops = 'down';
    this.opens = 'auto';
    const componentFactory = this._componentFactoryResolver.resolveComponentFactory(XMatDateRangePickerComponent);
    viewContainerRef.clear();
    const componentRef = viewContainerRef.createComponent(componentFactory);
    this.picker = <XMatDateRangePickerComponent>componentRef.instance;
  ...
  outsideClick(event): void {
    ...
    if (event.target.classList.contains('x-mat-date-range-picker-action')) {
      return;
    }
