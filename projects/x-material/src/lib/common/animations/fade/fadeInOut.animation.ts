 ...
 *
 * usage: [@xMatFadeInOut]="{ value: true | false, params: { duration: 200 }}"
 */
export const xMatFadeInOutAnimation: AnimationTriggerMetadata = trigger('xMatFadeInOut', [
  state(
    '0',
    style({
      opacity: '0',
